...
class EnvironmentProvider:
    ...
    def prepare_env_from_graph(graph: DiGraph, source, target, event_demand_value):
        ...
        links, links_usage_values, losses, delays = EnvironmentProvider.__prepare_links_and_links_usage_values(graph)
        print(f'Created links={links}\nlinks_usage_values={links_usage_values}')#MR
        ...
        env.links_losses = losses #MR
        env.links_delays = delays #MR
    ...
    def __prepare_links_and_links_usage_values(graph: DiGraph):
        ...
        for key, value in graph.edges.items():
            ...
            losses[link_id] = loss #MR
            delays[link_id] = delay #MR
        return new_links, links_usage_values, losses, delays
